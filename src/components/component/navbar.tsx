...
const NavBar = () => {
  ...
  return (
    <div className='fixed left-0 right-0 top-0 z-[40] flex h-16 items-center justify-center border-b-2 border-gray-300 border-opacity-35 bg-white bg-opacity-10 px-3 backdrop-blur-sm sm:px-0'>
